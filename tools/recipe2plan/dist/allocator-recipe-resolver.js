...
export class AllocatorRecipeResolver {
    ...
    async resolve() {
        ...
        const firstPass = [];
        //const recipes = [];
        for (const recipe of this.ast.recipes) {
